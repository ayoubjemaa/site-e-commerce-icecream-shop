        ...
        <section class="dashboard">
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <a href="add_products.php" class="btn">deactive product</a>
                </div>
                <div class="box">
                    <?php
                ...
                <div class="box">
                    ...
                    <a href="admin_order.php" class="btn">total confirm orders</a>
                </div>
                <div class="box">
                    <?php
                    ...
                    <a href="admin_order.php" class="btn">total canceled orders</a>
                </div>
            </div>
