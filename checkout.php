...
<head>
  ...
  <title>Blue Sky Summer - user checkout page</title>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>checkout</h1>
            <p>The checkout page lets you review your selected items and confirm your order details.  <br>
            Securely complete your purchase with fast and easy payment options.</p>
