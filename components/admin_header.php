        ...
        <?php
            ...
            <div class="profile">
                ...
                <div class="flex-btn">
                    ...
                    <a href="../components/admin_logout.php" onclick="
                    return confirm('logout from this website ?');" class="btn">logout</a>
                </div>
            </div>
        <?php  ?>
    </div>
    ...
    <?php
        ...
        <div class="navbar">
            <ul>
                ...
                <li><a href="../components/admin_logout.php" onclick=
                "return confirm('logout from this website ?')"><i class="bx bx-log-out"></i>logout</a></li>
            </ul>
        </div>
        <h5>find us</h5>
