<div class="newsletter">
    <div class="content">
        ...
        <p>Stay updated on our latest ice cream flavors and sweet deals.
        Get exclusive offers, mouthwatering updates, and more — straight to your inbox!</p>
...
<footer>
    <div class="content">
        <div class="box">
            ...
            <p>We are always in search for talented and motivated people.Don't be shy introduce
                yourself!
            </p>
        ...
        <div class="box">
            <h3>contact us</h3>
            <p><i class="bx bxs-phone"></i>(406) 55-0120</p>
            <p><i class="bx bxs-envelope"></i>ayoubjemaa@gmail.com</p>
            <p><i class="bx bxs-location-plus"></i>North Africa, Tunisia</p>
            <div class="icons">
    ...
    <div class="bottom">
        <p>© 2025 Blue Sky Summer. All rights reserved.</p>
